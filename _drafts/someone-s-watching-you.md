...
at large at this time. So let's get started.
...
online and can be collected. If we extend our example a little SMS traffic is
collected and stored also.
...
situations. Let's pair it with another related adage:

> If something seems too be good to be true, it probably is.
...
Often the answer to the last one is data about you!
...
Without realising the Orwellian undertones of such a statement.

To be clear, you may have "nothing to hide" now, but times do change and things
...
life. We see this with "cancel culture", where an author or comedian may have
...
annals of time never having been recorded but in an ever increasing online word
where everything is filed away and collated this will no longer be the case.

Another reason I personally find such a statement to be dangerous and insipid
is that it makes the claim that you should have no privacy because having
secrets or hiding things is automatically bad. This is patently absurd. We all
...
Privacy alone is not the only reason you should care. But it is a major one.
...
over people's daily lives. Take for instance email: Knowing who is communicating
with who, how frequently and heavily allows you to ascertain the relationships
between individuals. This can be very useful when put to good use, for example
finding terrorist cells or criminal gang networks. But such technology can be
as easily used against the innocent. Some non-western countries for instance
make it a capital offence to be homosexual and such mass surveillance
technologies enable them to persecute individuals based on their sexuality.  
...
insinuate an association with a now problematic group.
...
Cambridge Analyitica, Brexit and Trump on both sides of each of those topics.
...
Things like Signal, Wire and Matrix make decent replacement for the likes of
WhatsApp and other messenger applications.

The "Fediverse" replaces many traditional social media platforms with more
federated alternatives. Twitter can be replaced with Mastodon. YouTube can be
replaced by PeerTube.

You can set up your own "cloud" services with things like Nextcloud. Or use
Syncthing to synchronise data between multiple devices replacing Google Drive
and Dropbox.
...
possible to separate people into groups on Facebook for example.
...
the responses you get to it or are you simply fishing for attention?
...
This may seem like a choir but there are applications out there that help you
...
I recommend uBlock Origin for both Firefox and Chrome based browsers. It has
sophisticated filters that deal with most adverts.
...
Your Social Media profiles, emails, the satirical web-comics you read are only
as real as you allow them to be. Treat them as such and remember you have
ultimate control over what you share online. Nobody is forcing you to sign up
to Facebook or post pictures of your life on Instagram.
